...
### backend/tests/test_data_cleanup.py (310 строк)
...
- `DataCleanupTests.test_piggy_cleanup_drags_period_bookings_without_piggy_txdef test_piggy_cleanup_drags_period_bookings_without_piggy_tx(self) -> None: """Кредитная запись без проводок копилки тоже уходит при чистке копилки.""" from app.database import Se` (стр. 257)
