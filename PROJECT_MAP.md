...
- Файлов кода: **523**
- Строк кода: **208 530**
- По расширениям: `.js`: 3, `.mjs`: 5, `.py`: 172, `.ts`: 37, `.tsx`: 306
...
### backend/app/schemas.py (2420 строк)
...
- `PayrollEntryCreateRequest.validate_notedef validate_note(cls, value: str) -> str: return value.strip()` (стр. 917)
- `class PayrollEntryUpdateRequest(BaseModel):` (стр. 921)
- `PayrollEntryUpdateRequest.validate_notedef validate_note(cls, value: str) -> str: return value.strip()` (стр. 927)
- `class SettingsBundlePayload(BaseModel):` (стр. 931)
- `class SessionPayload(BaseModel):` (стр. 941)
- `class BootstrapPayload(BaseModel):` (стр. 954)
- `class ClientRegisterRequest(BaseModel):` (стр. 973)
- `ClientRegisterRequest.lift_profiledef lift_profile(cls, raw: Any) -> Any: if isinstance(raw, dict) and isinstance(raw.get("profile"), dict):` (стр. 985)
- `ClientRegisterRequest.validate_namedef validate_name(cls, value: str) -> str: if not value.strip():` (стр. 994)
- `ClientRegisterRequest.validate_phonedef validate_phone(cls, value: str) -> str: if not value.strip():` (стр. 1001)
- `ClientRegisterRequest.validate_vehicledef validate_vehicle(self) -> ClientRegisterRequest: if self.plate.strip():` (стр. 1007)
- `class ConsentRecordPayload(BaseModel):` (стр. 1013)
- `class ConsentCheckResponse(BaseModel):` (стр. 1018)
- `class StaffLinkRequest(BaseModel):` (стр. 1022)
- `class SwitchRoleRequest(BaseModel):` (стр. 1027)
- `class RolePreviewActor(BaseModel):` (стр. 1031)
- `class RolePreviewOption(BaseModel):` (стр. 1040)
- `class RolePreviewState(BaseModel):` (стр. 1047)
- `class RolePreviewRequest(BaseModel):` (стр. 1064)
- `_normalize_booking_datedef _normalize_booking_date(value: str) -> str: """Нормализует дату записи к канону ДД.ММ.ГГГГ. Принимает и ДД.ММ.ГГГГ, и ГГГГ-ММ-ДД (форматы, которые могут слать клиенты). Остальн` (стр. 1071)
- `_normalize_booking_timedef _normalize_booking_time(value: str) -> str: """Normalize booking time to HH:MM (24h) canonical form. Empty allowed.""" v = value.strip() if not v: return "" m = re.fullmatch(r"` (стр. 1092)
- `class BookingCreateRequest(BaseModel):` (стр. 1106)
- `BookingCreateRequest.validate_datedef validate_date(cls, value: str) -> str: return _normalize_booking_date(value)` (стр. 1132)
- `BookingCreateRequest.validate_timedef validate_time(cls, value: str) -> str: return _normalize_booking_time(value)` (стр. 1137)
- `BookingCreateRequest.validate_client_namedef validate_client_name(cls, value: str) -> str: if not value.strip():` (стр. 1142)
- `BookingCreateRequest.validate_client_phonedef validate_client_phone(cls, value: str) -> str: if not value.strip():` (стр. 1149)
- `BookingCreateRequest.validate_vehicledef validate_vehicle(self) -> BookingCreateRequest: if self.car is not None and self.car.strip():` (стр. 1155)
- `class AddBookingServiceRequest(BaseModel):` (стр. 1163)
- `class BookingUpdateRequest(BaseModel):` (стр. 1170)
- `BookingUpdateRequest.validate_datedef validate_date(cls, value: str | None) -> str | None: if value is None: return None return _normalize_booking_date(value)` (стр. 1196)
- `BookingUpdateRequest.validate_timedef validate_time(cls, value: str | None) -> str | None: if value is None: return None return _normalize_booking_time(value)` (стр. 1203)
- `BookingUpdateRequest.validate_client_namedef validate_client_name(cls, value: str | None) -> str | None: if value is None: return None return normalize_person_name(value)` (стр. 1210)
- `BookingUpdateRequest.validate_client_phonedef validate_client_phone(cls, value: str | None) -> str | None: if value is None: return None return normalize_phone(value)` (стр. 1217)
- `BookingUpdateRequest.validate_vehicledef validate_vehicle(self) -> BookingUpdateRequest: if self.car is not None and not self.car.strip():` (стр. 1223)
- `class ClientCardUpdateRequest(BaseModel):` (стр. 1236)
- `ClientCardUpdateRequest.validate_namedef validate_name(cls, value: str | None) -> str | None: if value is None: return None return normalize_person_name(value)` (стр. 1254)
- `ClientCardUpdateRequest.validate_phonedef validate_phone(cls, value: str | None) -> str | None: if value is None or not value.strip():` (стр. 1261)
- `ClientCardUpdateRequest.validate_vehicledef validate_vehicle(self) -> ClientCardUpdateRequest: if self.car is not None and not self.car.strip():` (стр. 1267)
- `class NotificationCreateRequest(BaseModel):` (стр. 1280)
- `class ReadAllNotificationsRequest(BaseModel):` (стр. 1287)
- `class StockItemCreateRequest(BaseModel):` (стр. 1291)
- `class StockItemUpdateRequest(BaseModel):` (стр. 1300)
- `class StockCategoryCreateRequest(BaseModel):` (стр. 1309)
- `class StockCategoryUpdateRequest(BaseModel):` (стр. 1314)
- `class StockWriteOffRequest(BaseModel):` (стр. 1319)
- `class StockWriteOffPayload(BaseModel):` (стр. 1323)
- `class IncomeCreateRequest(BaseModel):` (стр. 1341)
- `IncomeCreateRequest.validate_sourcedef validate_source(cls, value: str) -> str: stripped = value.strip() if not stripped: raise ValueError("source не может быть пустым или состоять только из пробелов") return stripp` (стр. 1350)
- `IncomeCreateRequest.validate_datedef validate_date(cls, value: str) -> str: if not re.fullmatch(r"\d{2}\.\d{2}\.\d{4}", value.strip()):` (стр. 1358)
- `class IncomePayload(BaseModel):` (стр. 1364)
- `IncomePayload._validate_amountdef _validate_amount(cls, value: Any) -> int: return _coerce_money_int(value)` (стр. 1376)
- `class ExpenseCreateRequest(BaseModel):` (стр. 1380)
- `ExpenseCreateRequest.validate_datedef validate_date(cls, value: str) -> str: if not re.fullmatch(r"\d{2}\.\d{2}\.\d{4}", value.strip()):` (стр. 1390)
- `class PenaltyCreateRequest(BaseModel):` (стр. 1396)
- `class OwnerReminderDispatchRequest(BaseModel):` (стр. 1402)
- `class OwnerReminderDispatchPayload(BaseModel):` (стр. 1407)
- `class StaffLoginRequest(BaseModel):` (стр. 1415)
- `class ChangePasswordRequest(BaseModel):` (стр. 1420)
- `class OwnerDatabaseResetPreviewPayload(BaseModel):` (стр. 1425)
- `class OwnerDatabaseResetStartRequest(BaseModel):` (стр. 1440)
- `class OwnerDatabaseResetApproveRequest(BaseModel):` (стр. 1444)
- `class OwnerDatabaseResetExecuteRequest(BaseModel):` (стр. 1450)
- `class OwnerDatabaseResetStartPayload(BaseModel):` (стр. 1454)
- `class OwnerDatabaseResetApprovePayload(BaseModel):` (стр. 1463)
- `class OwnerDatabaseResetExecutePayload(BaseModel):` (стр. 1471)
- `class ContentAboutPayload(BaseModel):` (стр. 1476)
- `class ContentServicePayload(BaseModel):` (стр. 1482)
- `class ContentWorksPayload(BaseModel):` (стр. 1493)
- `class ContentStatsPayload(BaseModel):` (стр. 1499)
- `class ContentTitlePayload(BaseModel):` (стр. 1504)
- `ContentTitlePayload.to_full_titledef to_full_title(self) -> str: return f"{self.before}{self.highlight}{self.after}"` (стр. 1509)
- `class ContentHeroPayload(BaseModel):` (стр. 1513)
- `class ContentPayload(BaseModel):` (стр. 1529)
- `class ContactPayload(BaseModel):` (стр. 1536)
- `class ResetPasswordRequest(BaseModel):` (стр. 1543)
- `class GenericMessage(BaseModel):` (стр. 1547)
- `class TelegramDeliveryResult(BaseModel):` (стр. 1551)
- `class TelegramBroadcastPayload(BaseModel):` (стр. 1557)
- `class OwnerExportDeliveryPayload(BaseModel):` (стр. 1563)
- `class ShiftAttendancePayload(BaseModel):` (стр. 1570)
- `class ExpenseUpdateRequest(BaseModel):` (стр. 1581)
- `ExpenseUpdateRequest.validate_titledef validate_title(cls, value: str | None) -> str | None: if value is None: return None stripped = value.strip() if not stripped: raise ValueError("title не может быть пустым или с` (стр. 1591)
- `ExpenseUpdateRequest.validate_datedef validate_date(cls, value: str | None) -> str | None: if value is None: return None if not re.fullmatch(r"\d{2}\.\d{2}\.\d{4}", value):` (стр. 1601)
- `ExpenseUpdateRequest.require_at_least_one_fielddef require_at_least_one_field(self) -> ExpenseUpdateRequest: if all(v is None for v in [self.title, self.amount, self.category, self.date, self.note]):` (стр. 1609)
- `class IncomeUpdateRequest(BaseModel):` (стр. 1615)
- `IncomeUpdateRequest.validate_sourcedef validate_source(cls, value: str | None) -> str | None: if value is None: return None stripped = value.strip() if not stripped: raise ValueError("source не может быть пустым или` (стр. 1624)
- `IncomeUpdateRequest.validate_datedef validate_date(cls, value: str | None) -> str | None: if value is None: return None if not re.fullmatch(r"\d{2}\.\d{2}\.\d{4}", value):` (стр. 1634)
- `IncomeUpdateRequest.require_at_least_one_fielddef require_at_least_one_field(self) -> IncomeUpdateRequest: # Use model_fields_set to detect explicitly provided fields (including null). # This allows {"note": null} to pass as a` (стр. 1642)
- `class PiggyBankTransactionPayload(BaseModel):` (стр. 1650)
- `class PiggyBankWithdrawRequest(BaseModel):` (стр. 1679)
- `PiggyBankWithdrawRequest.validate_datedef validate_date(cls, value: str) -> str: if not re.fullmatch(r"\d{2}\.\d{2}\.\d{4}", value.strip()):` (стр. 1705)
- `PiggyBankWithdrawRequest.validate_spent_by_namedef validate_spent_by_name(cls, value: str | None) -> str | None: if value is None: return None stripped = value.strip() return stripped or None` (стр. 1712)
- `class PiggyBankAdjustRequest(BaseModel):` (стр. 1719)
- `PiggyBankAdjustRequest.validate_datedef validate_date(cls, value: str) -> str: stripped = value.strip() if stripped and not re.fullmatch(r"\d{2}\.\d{2}\.\d{4}", stripped):` (стр. 1727)
- `class PiggyBankWashBreakdown(BaseModel):` (стр. 1734)
- `class PiggyBankDetailingBreakdown(BaseModel):` (стр. 1747)
- `class PiggyBankSpenderDebt(BaseModel):` (стр. 1758)
- `class PiggyBankResponse(BaseModel):` (стр. 1765)
- `class WeeklyArchivePayload(BaseModel):` (стр. 1785)
- `class WalletResponse(BaseModel):` (стр. 1799)
- `class OwnerProfitShareItem(BaseModel):` (стр. 1816)
- `class OwnerProfitShareSummary(BaseModel):` (стр. 1833)
- `class OwnerSalaryDetailResponse(BaseModel):` (стр. 1842)
- `class PayOwnerSalaryRequest(BaseModel):` (стр. 1849)
- `class PayOwnerSalaryResponse(BaseModel):` (стр. 1858)
- `class OverrideEarnedRequest(BaseModel):` (стр. 1865)
- `class BookingHistoryItem(BaseModel):` (стр. 1869)
- `class BookingTotalsWorkerItem(BaseModel):` (стр. 1886)
- `class BookingTotalsOwnerItem(BaseModel):` (стр. 1904)
- `class BookingTotalsPiggyItem(BaseModel):` (стр. 1911)
- `class BookingHistoryTotals(BaseModel):` (стр. 1917)
- `class BookingMoneySplitWorkerItem(BaseModel):` (стр. 1923)
- `class BookingMoneySplitOwnerItem(BaseModel):` (стр. 1934)
- `class BookingPiggyTxItem(BaseModel):` (стр. 1942)
- `class BookingAdditionalServiceItem(BaseModel):` (стр. 1951)
- `class BookingAsvcPiggyItem(BaseModel):` (стр. 1960)
- `class BookingAsvcWorkerItem(BaseModel):` (стр. 1966)
- `class BookingMoneySplitDetail(BaseModel):` (стр. 1977)
- `class BookingWorkerEarnedUpdate(BaseModel):` (стр. 2025)
- `class BookingMoneySplitOwnerUpdate(BaseModel):` (стр. 2030)
- ...ещё 31
...
### backend/tests/test_v1_gaps.py (205 строк)
...
- `backend/app/schemas.py` (2026-09-04 09:12)
