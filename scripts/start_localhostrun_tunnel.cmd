...
start "" /b C:\Windows\System32\OpenSSH\ssh.exe -o StrictHostKeyChecking=accept-new -o ServerAliveInterval=30 -R 80:127.0.0.1:8765 nokey@localhost.run 1>"%OUT%" 2>"%ERR%"
