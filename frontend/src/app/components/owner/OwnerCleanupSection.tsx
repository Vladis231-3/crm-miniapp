...
const ENTITY_FALLBACK: Record<string, { title: string; description: string }> = {
  ...
  piggy: { title: 'Копилка', description: 'Копилка: накопления процента с записей и траты из копилки. Вместе с копилкой уйдут связанные записи и зеркальные расходы — иначе Выручка/ЗП останутся, а баланс уйдёт в минус. Для полного сброса добавьте Доходы+Расходы за тот же период.' },
