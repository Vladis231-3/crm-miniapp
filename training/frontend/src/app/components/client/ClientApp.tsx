...
export function ClientApp() {
  ...
  return (
    <div className={`${isDark ? 'dark' : ''} atmosfera-shell ${bg} ${text} min-h-screen flex flex-col relative`}>
      {/* Header */}
      <div data-training="client-header" className={`work-header ${glass} flex items-center justify-between`}>
      ...
      {/* Bottom Nav */}
      <div data-training="client-nav" className="role-nav"><div className="role-nav__scroll">
        <button
      ...
      <div className="flex-1 overflow-y-auto pb-24">
        <AnimatePresence mode="wait">
          ...
          {page === 'catalog' && (
            ...
            >
              {/* Search */}
              <div data-training="client-search" className="px-4 pt-4">
                <ServiceSearchInput
              ...
              {/* Category chips */}
              <div data-training="client-categories" className="flex gap-2 px-4 py-3 overflow-x-auto" style={{ scrollbarWidth: 'none' }}>
                {categories.map(cat => (
                  <button
                    key={cat}
              ...
              {/* Services grid */}
              <div data-training="client-services" className="px-4 grid grid-cols-1 gap-3">
