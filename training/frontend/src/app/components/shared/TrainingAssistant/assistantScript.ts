...
export const TRAINING_INTRO: IntroSlide[] = [
  ...
  },
  {
    ...
    text: 'Я — ваш мини-помощник. Летаю по всем окнам, подсвечиваю элементы и объясняю, за что они отвечают. Выберите роль — и поехали!',
  },
];
...
export const TRAINING_SCRIPT: TourStep[] = [
  ...
  // ── Финал (показывается после любой роли) ─────────────────────────────
  {
    role: 'all',
    title: 'Тур завершён!',
    text: 'Отлично! Хотите пройти обучение для другой роли? Выберите её у помощника — я покажу все окна и подсветю нужные места.',
  },
];
