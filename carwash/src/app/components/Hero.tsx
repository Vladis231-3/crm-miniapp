...
const HERO_IMG =
  "https://images.unsplash.com/photo-1607860108855-64acf2078ed9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwzfHxjYXIlMjB3YXNoJTIwZGV0YWlsaW5nJTIwbHV4dXJ5fGVufDF8fHx8MTc4MDQxMDI0OXww&ixlib=rb-4.1.0&q=80&w=1080";
    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 w-full">
        <div className="max-w-xl">
          <div
            className="inline-flex items-center gap-2 bg-blue-600/20 border border-blue-400/30 text-blue-300 px-4 py-1.5 rounded-full mb-6"
          ...
          >
            Your Car Deserves{" "}
            <span className="text-blue-400">the Best</span> Treatment
          </h1>
          ...
          >
            Premium car wash and detailing services that restore your vehicle's
            shine. From express washes to full ceramic coatings — we deliver
