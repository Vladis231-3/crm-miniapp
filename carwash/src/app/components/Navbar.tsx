  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        {/* Mobile toggle */}
        <button
          className={`md:hidden p-2 rounded-lg cursor-pointer bg-transparent border-none ${
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 shadow-lg">
          <nav className="px-6 py-4 flex flex-col gap-1">
            ...
            <button
              onClick={() => handleNav("#contact")}
              className="mt-3 bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition-colors cursor-pointer border-none"
