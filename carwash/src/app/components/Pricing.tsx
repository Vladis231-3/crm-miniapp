...
const FALLBACK_PLANS = [
  {
    ...
    notIncluded: ["Interior vacuum", "Polish & wax", "Ceramic protection"],
  },
  {
    name: "Premium",
    ...
    notIncluded: ["Polish & wax", "Ceramic protection"],
  },
  {
    name: "Ultimate",
    tagline: "Complete showroom finish",
    price: 249,
    period: "per detail",
    color: "#7c3aed",
    highlight: false,
    ...
    <section id="pricing" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            No hidden fees. What you see is what you pay — premium service at a fair price.
          </p>
        </div>
          ...
          {plans.map((plan) => (
            <div
              ...
              className={`rounded-2xl p-8 flex flex-col border transition-all duration-300 ${
                plan.highlight ? "shadow-xl scale-105 border-blue-200" : "shadow-sm border-gray-100"
              }`}
              style={{ backgroundColor: plan.highlight ? "#ffffff" : "#fafafa" }}
            >
              {plan.highlight && (
                <div
                  className="text-white text-xs font-bold px-3 py-1 rounded-full self-start mb-4"
                  style={{ backgroundColor: plan.color, letterSpacing: "0.05em" }}
                >
                  MOST POPULAR
                </div>
              )}
              ...
              <div className="my-6">
                <span style={{ fontWeight: 800, fontSize: "2.5rem", color: "#0f172a" }}>
                  ${plan.price}
                </span>
                <span className="text-gray-400" style={{ fontSize: "0.9rem" }}>
                  /{plan.period}
                </span>
              </div>
              ...
              <div className="flex-1">
                ...
                {plan.notIncluded.length > 0 && (
                  <>
                    <div className="text-sm font-semibold text-gray-400 mt-5 mb-3">Not included:</div>
